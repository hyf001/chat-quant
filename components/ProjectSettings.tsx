...
const CLI_OPTIONS: CLIOption[] = [
  {
    ...
    checkCommand: 'python -c "import claude_agent_sdk"',
    downloadUrl: 'https://pypi.org/project/claude-agent-sdk/',
    installCommand: 'pip install claude-agent-sdk>=0.1.2',
    models: [
      { id: 'claude-sonnet-4-5', name: 'Claude Sonnet 4.5', description: 'Latest and most capable Sonnet model' },
    ...
    features: ['Python SDK integration', 'Advanced reasoning', 'Tool orchestration', '1M context window']
  },
  {
    id: 'cursor',
    name: 'Cursor Agent',
...
export default function ProjectSettings({ isOpen, onClose, projectId, projectName, initialTab = 'general' }: ProjectSettingsProps) {
  ...
  const [globalSettings, setGlobalSettings] = useState<GlobalSettings>({
    ...
    cli_settings: {
      agent: { model: 'claude-sonnet-4-5', enabled: true },
