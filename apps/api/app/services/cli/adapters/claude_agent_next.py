...
class ClaudeAgentCLINext(BaseCLI):
    """Claude Agent Python SDK implementation"""

    def __init__(self,project_id:str,model:str):
        super().__init__(AgentType.NEXT_JS,project_id,model)
    ...
    def init_claude_option(self,
                       project_id: str,
                       model: Optional[str] = None,) -> ClaudeSDKClient:
        """connect and return Claude Agent SDK client"""
        options = ClaudeAgentOptions()
        return ClaudeSDKClient(options=options)

    async def disconnect_claude(self):
        """close the client"""
    ...
    async def execute_with_streaming(
        ...
        try:
            ...
            system_prompt = get_system_prompt(AgentType.NEXT_JS)
        ...
        cli_model = model or "claude-sonnet-4-5-20250929"
