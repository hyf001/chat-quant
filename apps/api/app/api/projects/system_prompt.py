...
import app.services.claude_act as claude_act
...
async def get_project_system_prompt(project_id: str, db: Session = Depends(get_db)):
    ...
    # system_prompt = get_system_prompt(project_id,AgentType.NEXT_JS)
    system_prompt = claude_act.get_system_prompt(AgentType.NEXT_JS)
