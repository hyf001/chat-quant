...
class ProjectCreate(BaseModel):
    ...
    preferred_cli: Optional[str] = AgentType.NEXT_JS.value
    ...
    try:
        ...
        try:
            ...
            async def init_project_task():
                # Pass agent_type directly (already known from body.preferred_cli)
                project_path = await initialize_project(
                    project_id,
                    project_name,
                    agent_type=body.preferred_cli
                )
...
async def create_project(
    ...
    preferred_cli = body.preferred_cli or AgentType.NEXT_JS.value
