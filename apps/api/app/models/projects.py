...
class Project(Base):
    ...
    # Session Management
    active_session_id: Mapped[str | None] = mapped_column(String(128), nullable=True)  # Active CLI session ID

    # CLI Preferences
    preferred_cli: Mapped[str] = mapped_column(String(32), default=AgentType.NEXT_JS.value, nullable=False)  # CLI adapter type (agent)
